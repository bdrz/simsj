...
<div class="container-fluid">
  <div class="fade-in">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h4>List Leader</h4></div>
            <div class="card-body">
                <table 
                class="table-sm"
                id="table"
                    ...
                    @foreach ($member as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-info btn-sm" href="/leader/profile/{{ $item->id }}"><i class="fa fa-user"></i></a>
                                <a class="btn btn-primary btn-sm" href="/leader/edit/{{ $item->id }}"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Apakah Anda yakin ingin menghapus Data Leader: <b><span id="nama"></span></b>? <br>Seluruh data yang tersimpan di server akan hilang secara permanen!</p>
      </div>
      <div class=""></div>
      <div class="modal-footer">
          
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
        <form method="POST" action="{{ route('leader.delete') }}">
            @csrf
