          ...
          <div class="text-right mb-2" style="margin-top: -20px">
              <a href="/user/tambah">
                <button class="btn btn-dark btn-sm">
                    <i class="fa fa-user-plus mr-1"></i> Tambah User Baru
                </button>         
            </a>
            </div>
        <div class="card">
          <div class="card-header">
                ...
                Profile User
                <a href="/user/edit/{{ $profile->id }}">
                    <button class="btn btn-primary float-right"><i class="fa fa-edit mr-1"></i>Edit User</button>
                </a>
                </h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-bordered table-sm text-sm">
                            ...
                            <tr>
                                ...
                                <td><b>{{ $profile->hp }}</b></td>
                            </tr>
                            <tr>
                                <td>NPWP</td>
                                <td>{{ $profile->nomor_npwp }}</td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                            ...
                            <tr>
                                <td>Tanggal Lahir</td>
                                <td>{{ date('d/m/Y', strtotime($profile->tgl_lahir)) }}</td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
