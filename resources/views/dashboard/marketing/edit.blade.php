      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
                <h4>
                <a href="/marketing/profile/{{ $profile->id }}">
            ...
            <div class="card-body">
                ...
                @endif   
               <form method="POST" action="{{ route('marketing.edit') }}" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <table class="table table-bordered table-sm text-sm">
                            <tr>
                                <td class="bg-light text-dark align-middle">Leader</td>
                                <td> 
                                  <select class="form-control" name="leader_id">
                                    @foreach ($leader as $item)
                                    @if ($item->id == $profile->leader->id)
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="nik" class="form-control" value="{{ $profile->nik }}"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td class="bg-light text-dark align-middle">Alamat</td>
                              <td><input type="text" name="alamat" class="form-control" value="{{ $profile->alamat }}"></td>
                            </tr>
                            <tr>
                                <td class="align-middle">Bank</td>
                                <td><input type="text" name="bank_rek" class="form-control" value="{{ $profile->bank_rek }}"></td>
                            </tr>
                            <tr>
                                <td class="align-middle">Nomor Rekening</td>
                                <td><input type="number" name="no_rek" class="form-control" value="{{ $profile->no_rek }}"></td>
                            </tr>
                            <tr>
                                <td class="align-middle">Atas Nama Rekening</td>
                                <td><input type="text" name="an_rek" class="form-control" value="{{ $profile->an_rek }}"></td>
                            </tr>
