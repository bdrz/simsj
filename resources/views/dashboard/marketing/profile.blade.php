    ...
    <div class="row">
      <div class="col-sm-12">
          <div class="text-right mb-2" style="margin-top: -20px">
              <a href="/marketing/tambah">
                <button class="btn btn-dark btn-sm">
                    <i class="fa fa-user-plus mr-1"></i> Tambah Marketing Baru
                </button>         
            </a>
            </div>
        <div class="card">
          <div class="card-header">
                ...
                Profile Marketing
                <a href="/marketing/edit/{{ $profile->id }}">
                    <button class="btn btn-primary float-right"><i class="fa fa-edit mr-1"></i>Edit Marketing</button>
                </a>
                </h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <table class="table table-bordered table-sm text-sm">
                            <tr>
                                <td class="bg-light text-dark">Leader</td>
                                <td>
                                  <a href="/leader/profile/{{ $profile->leader->id }}">
                                  <b>{{ $profile->leader->nama }}</b></a>
                                </td>
                            </tr>
                            <tr>
