...
<div class="container-fluid">
  <div class="fade-in">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h4>List Marketing</h4></div>
            <div class="card-body">
                <table 
                class="table-sm"
                id="table"
                ...
                <thead>
                    ...
                    <th data-halign="center" data-width="200">Leader</th>
                    <th data-halign="center">Nama Marketing</th>
                ...
                <tbody>
                    ...
                    @foreach ($member as $item)
                        <tr>
                            ...
                            <td>
                              <a href="/leader/profile/{{ $item->leader->id }}">{{ $item->leader->nama }}</a>
                            </td>
                            <td>{{ $item->nama }}</td>
                            <td>{{ $item->hp }}</td>
                            <td class="text-center">
                                <a class="btn btn-info btn-sm" href="/marketing/profile/{{ $item->id }}"><i class="fa fa-user"></i></a>
                                <a class="btn btn-primary btn-sm" href="/marketing/edit/{{ $item->id }}"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form method="POST" action="{{ route('marketing.delete') }}">
            @csrf
