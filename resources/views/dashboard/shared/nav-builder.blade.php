...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/base-white.png') }}" height="46" alt="SIMSJ Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/signet-white.png') }}"  height="46" alt="SIMSJ Logo">
        </div>
