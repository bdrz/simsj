    ...
    <div class="c-wrapper">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav ml-auto mr-4">
          <li class="c-header-nav-item mx-2 text-right">
            <strong class="m-0">{{ auth()->user()->name }}</strong>

            <h6 class="m-0">
              @if (auth()->user()->menuroles=='manager')
                  MANAGER
              @else
                  STAFF
              @endif
        ...
        <div class="c-subheader px-3">
          <ol class="breadcrumb border-0 m-0 text-uppercase">
